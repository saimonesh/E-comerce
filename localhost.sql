...
--
-- Host: localhost
-- Generation Time: Mar 27, 2017 at 04:02 PM
...
-- Database: `customs`
--
CREATE DATABASE `customs` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `customs`;
...
INSERT INTO `customer` (`A`, `B`) VALUES
(90, 110);

-- --------------------------------------------------------

--
-- Table structure for table `imp_name`
--

CREATE TABLE IF NOT EXISTS `imp_name` (
  `Name` varchar(20) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `imp_name`
--

INSERT INTO `imp_name` (`Name`) VALUES
('importer1'),
('importer2'),
('SAI'),
('sai'),
...
CREATE TABLE IF NOT EXISTS `importer` (
  `Imp_no` int(5) NOT NULL,
  `Imp_date` varchar(15) DEFAULT NULL,
  `Imp_name` varchar(20) DEFAULT NULL,
  `Supp_name` varchar(20) DEFAULT NULL,
  `Invoice_no` int(5) DEFAULT NULL,
  ...
  `Landed_date` varchar(20) DEFAULT NULL,
  `Moved_date` varchar(20) DEFAULT NULL,
  `HBL` int(10) DEFAULT NULL,
  `HBL_Date` varchar(20) DEFAULT NULL,
  `MBL_Date` varchar(20) DEFAULT NULL,
  `MBL` int(10) DEFAULT NULL,
  `No_packages` int(10) DEFAULT NULL,
  `Gross_weight` int(10) DEFAULT NULL,
  `Net_weight` varchar(20) DEFAULT NULL,
  `Description` varchar(10) DEFAULT NULL,
  `List_containers` varchar(150) DEFAULT NULL,
  `Console` varchar(10) DEFAULT NULL,
  `Liner` varchar(15) DEFAULT NULL,
  `CFS_name` varchar(15) DEFAULT NULL,
  `BOE_no` int(30) DEFAULT NULL,
  `BOE_Date` varchar(20) DEFAULT NULL,
  `Kind_of_BOE` varchar(20) DEFAULT NULL,
  `Console_do_charges` int(10) DEFAULT NULL,
  `Liner_do_charges` int(10) DEFAULT NULL,
  `Free_day` varchar(20) DEFAULT NULL,
  `CFS_charges` varchar(20) DEFAULT NULL,
  `Type_of_BOE` varchar(10) DEFAULT NULL,
...
INSERT INTO `importer` (`Imp_no`, `Imp_date`, `Imp_name`, `Supp_name`, `Invoice_no`, `Invoice_date`, `INVOICE_AMOUNT`, `INSURANCE_AMOUNT`, `FREIGHT_AMOUNT`, `Currency`, `Term_of_payment`, `ETA`, `Vessel_name`, `Landed_date`, `Moved_date`, `HBL`, `HBL_Date`, `MBL_Date`, `MBL`, `No_packages`, `Gross_weight`, `Net_weight`, `Description`, `List_containers`, `Console`, `Liner`, `CFS_name`, `BOE_no`, `BOE_Date`, `Kind_of_BOE`, `Console_do_charges`, `Liner_do_charges`, `Free_day`, `CFS_charges`, `Type_of_BOE`, `BILL_no`, `BILL_date`) VALUES
(2, '16-Feb-17', '', '', 0, '16-Feb-17', '', NULL, NULL, '', '', '', '', '16-Feb-17', '16-Feb-17', 0, '16-Feb-17', '16-Feb-17', 0, 0, 0, '', '', NULL, '', '', '', NULL, NULL, NULL, 0, 0, '', '', NULL, NULL, NULL),
(1, '16-Feb-17', 'dsa', 'dsa', 1232, '16-Feb-17', '322', NULL, NULL, '43', '321', '132', '23', '16-Feb-17', '16-Feb-17', 13, '16-Feb-17', '16-Feb-17', 13, 32, 32, '34', '23', NULL, 'sad', 'ds', 'sd', 25, '23-Feb-17', 'OPEN	', 0, 0, 'as', 'ds', 'WAREHOUSE', 12, '16-Feb-17'),
(3, '17-Feb-17', 'importer2', 'sai', 15, '17-Feb-17', '45', NULL, NULL, '45', 'CIF', '15', 'sad', '17-Feb-17', '17-Feb-17', 153, '17-Feb-17', '17-Feb-17', 153, 415, 15, '15', '78', 'System.Collections.ArrayList', '155', '15', '151', NULL, NULL, NULL, 15, 15, '51', '15', NULL, NULL, NULL),
(4, '17-Feb-17', 'importer1', 'sai', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 15, '17-Feb-17', '17-Feb-17', 15, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, '17-Feb-17', 'importer1', 'sai', 15, '17-Feb-17', '45', NULL, NULL, '45', 'CF', '15', '45', '17-Feb-17', '17-Feb-17', 15, '17-Feb-17', '17-Feb-17', 15, 0, 15, '15', 'sad', 'sai,monesh', '15', '78', '45', NULL, NULL, NULL, 45, 45, '78', '45', NULL, NULL, NULL),
(6, '19-Feb-17', 'THE HIMALAYA DRUG CO', 'IOI PAN CENTURY', 90111256, '19-Feb-17', '126600', NULL, NULL, 'USD', 'CIF', '09.06.2017', 'X PRESS MAKLAU ', '19-Feb-17', '19-Feb-17', 0, '19-Feb-17', '19-Feb-17', 0, 4800, 120768, '120000', 'SOAP NOODL', 'BLZU2568976,APLZU5268797,APLZU5268797', '', 'AISSA MARITIME', 'GATEWAY ', 8859726, '19-Feb-17', 'RMS', 0, 0, '14', '', 'HOME', 0, '19-Feb-17'),
(7, '11-Mar-17', 'importer1', 'sadk;l', 321, '15-Feb-17', '15', '1515', '5000', '515', 'CF', '1515', 'sdai', '21-Feb-17', '15-Feb-17', 5, '08-Feb-17', '08-Feb-17', 5, 51, 15, '515', '151', '1,2,3', '16', '6', '51', NULL, NULL, NULL, 15, 56, '16', '5', NULL, NULL, NULL),
(8, '12-Mar-17', 'importer1', 'ASD', 12, '12-Mar-17', '12', '21', '12', '12', '21', '12', '12', '12-Mar-17', '12-Mar-17', 12, '12-Mar-17', '12-Mar-17', 12, 12, 15, '12', '12', 'SAI,KARTHI', '12', '15', '2', NULL, NULL, NULL, 12, 21, '12', '12', NULL, NULL, NULL);
--
...
(NULL, 'customs', 'customer', 'A', 1, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'customer', 'B', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'imp_name', 'Name', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Imp_no', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', 'PRI', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Imp_date', 2, NULL, 'YES', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Imp_name', 3, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Supp_name', 4, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Invoice_no', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Invoice_date', 6, NULL, 'YES', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'INVOICE_AMOUNT', 7, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'INSURANCE_AMOUNT', 8, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'FREIGHT_AMOUNT', 9, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Currency', 10, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Term_of_payment', 11, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'ETA', 12, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Vessel_name', 13, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Landed_date', 14, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Moved_date', 15, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'HBL', 16, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'HBL_Date', 17, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'MBL_Date', 18, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'MBL', 19, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'No_packages', 20, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Gross_weight', 21, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Net_weight', 22, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Description', 23, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'List_containers', 24, NULL, 'YES', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Console', 25, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Liner', 26, NULL, 'YES', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'CFS_name', 27, NULL, 'YES', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'BOE_no', 28, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'BOE_Date', 29, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Kind_of_BOE', 30, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Console_do_charges', 31, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Liner_do_charges', 32, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Free_day', 33, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'CFS_charges', 34, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'Type_of_BOE', 35, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'BILL_no', 36, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'customs', 'importer', 'BILL_date', 37, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
...
(NULL, 'student', 'about', 'S.NO', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'student', 'about', 'NAME', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'student', 'about', 'CLASS', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(5)', '', '', 'select,insert,update,references', ''),
(NULL, 'student', 'about', 'SEC', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', '', '', 'select,insert,update,references', ''),
(NULL, 'vendor', 'vendor_sell', 'Name', 1, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'vendor', 'vendor_sell', 'Price', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'vendor', 'vendor_sell', 'Mail', 3, NULL, 'YES', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'vendor', 'vendor_sell', 'Item', 4, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'vendor', 'vendor_sell', 'Item_type', 5, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'vendor', 'vendor_sell', 'Date', 6, NULL, 'YES', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
(NULL, 'vendor', 'vendor_sell', 'Desc', 7, NULL, 'YES', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', '');
...
('BINLOG_CACHE_USE', '8'),
('BYTES_RECEIVED', '80934'),
('BYTES_SENT', '1725854'),
('COM_ADMIN_COMMANDS', '198'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '231'),
('CREATED_TMP_DISK_TABLES', '158'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '730'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '175'),
('HANDLER_READ_KEY', '0'),
('HANDLER_READ_NEXT', '0'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '43444'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '346994'),
('UPTIME_SINCE_FLUSH_STATUS', '346994');
...
('RAND_SEED1', ''),
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DESKTOP-2AVSTRM-slow.log'),
...
('THREAD_STACK', '262144'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DESKTOP-2AVSTRM.log'),
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.53\\data\\DESKTOP-2AVSTRM.pid'),
('EXPIRE_LOGS_DAYS', '0'),
('NAMED_PIPE', 'OFF'),
...
(NULL, 'customs', 'PRIMARY', NULL, 'customs', 'importer', 'Imp_no', 1, NULL, NULL, NULL, NULL),
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-03-27 21:32:34', '2017-03-27 21:32:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-03-27 21:32:34', '2017-03-27 21:32:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-03-27 21:32:34', '2017-03-27 21:32:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-03-27 21:32:34', '2017-03-27 21:32:34', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-03-27 21:32:34', '2017-03-27 21:32:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-03-27 21:32:34', '2017-03-27 21:32:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-03-27 21:32:34', '2017-03-27 21:32:34', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-03-27 21:32:34', '2017-03-27 21:32:34', NULL, NULL, '', '', NULL),
(NULL, 'customs', 'customer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 9, 18, 2533274790395903, 1024, 9, '2017-03-23 22:21:32', '2017-03-23 23:09:21', NULL, NULL, '', '', NULL),
(NULL, 'customs', 'imp_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 21, 280, 281474976710655, 1024, 0, '2016-12-20 21:44:01', '2017-03-23 19:19:38', NULL, NULL, '', '', NULL),
(NULL, 'customs', 'importer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 172, 1376, 281474976710655, 2048, 0, '2017-02-19 14:36:12', '2017-03-12 20:03:20', NULL, NULL, '', '', NULL),
...
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 85, 256, 281474976710655, 2048, 0, '2010-11-03 19:52:43', '2016-12-20 21:03:59', NULL, NULL, '', '', NULL),
(NULL, 'student', 'about', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 20, 40, 281474976710655, 1024, 0, '2016-12-20 10:18:15', '2016-12-20 10:21:04', NULL, NULL, '', '', NULL),
(NULL, 'vendor', 'vendor_sell', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 124, 124, 281474976710655, 1024, 0, '2017-03-22 22:54:39', '2017-03-23 21:38:23', NULL, NULL, '', '', NULL);
...
(230, 'root', 'localhost:28379', 'customs', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'customs', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'student', 'latin1', 'latin1_swedish_ci', NULL),
(NULL, 'vendor', 'latin1', 'latin1_swedish_ci', NULL);
...
(NULL, 'customs', 'importer', 0, 'customs', 'PRIMARY', 1, 'Imp_no', 'A', 8, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-03-27 21:32:35', '2017-03-27 21:32:35', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-03-27 21:32:35', '2017-03-27 21:32:35', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-03-27 21:32:35', '2017-03-27 21:32:35', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-03-27 21:32:35', '2017-03-27 21:32:35', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-03-27 21:32:35', '2017-03-27 21:32:35', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-03-27 21:32:35', '2017-03-27 21:32:35', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-03-27 21:32:35', '2017-03-27 21:32:35', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-03-27 21:32:35', '2017-03-27 21:32:35', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'customs', 'customer', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 9, 18, 2533274790395903, 1024, 9, NULL, '2017-03-23 22:21:32', '2017-03-23 23:09:21', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'customs', 'imp_name', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 13, 21, 280, 281474976710655, 1024, 0, NULL, '2016-12-20 21:44:01', '2017-03-23 19:19:38', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'customs', 'importer', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 8, 172, 1376, 281474976710655, 2048, 0, NULL, '2017-02-19 14:36:12', '2017-03-12 20:03:20', NULL, 'latin1_swedish_ci', NULL, '', ''),
...
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 85, 256, 281474976710655, 2048, 0, NULL, '2010-11-03 19:52:43', '2016-12-20 21:03:59', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'student', 'about', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 20, 40, 281474976710655, 1024, 0, NULL, '2016-12-20 10:18:15', '2016-12-20 10:21:04', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'vendor', 'vendor_sell', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 124, 124, 281474976710655, 1024, 0, NULL, '2017-03-22 22:54:39', '2017-03-23 21:38:23', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'customs', 'PRIMARY', 'customs', 'importer', 'PRIMARY KEY'),
...
('localhost', 'root', '*2B18499BA2E76F9C89C6E3E468EB8D2CC69C5900', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
('127.0.0.1', 'root', '*2B18499BA2E76F9C89C6E3E468EB8D2CC69C5900', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0),
...
INSERT INTO `about` (`S.NO`, `NAME`, `CLASS`, `SEC`) VALUES
(1, '0', 0, 0),
(1, 'sai', 0, 0);
--
-- Database: `vendor`
...
INSERT INTO `vendor_sell` (`Name`, `Price`, `Mail`, `Item`, `Item_type`, `Date`, `Desc`) VALUES
('SAI', 78, ' moneshsai31@gmail.com', 'tomato', 'Vegetables', '2017-03-23 00:00:00', 'FRESH AND NEW');
